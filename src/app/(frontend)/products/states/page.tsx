...
export const metadata = {
    title: `Dentist Email Lists by State | ${WEBSITE_SEO_TITLE}`,
    description:
    ...
    alternates: {
        canonical: `${process.env.NEXT_PUBLIC_BASE_URL}/products/states`,
    },
};

const ProductStatesPage = async () => {
...
export default ProductStatesPage;
